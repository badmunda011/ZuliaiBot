...
async def generate_logo(zuli, message):
    ...
    r = requests.post("https://api.deepai.org/api/logo-generator", data=data, headers=headers)
    response = r.json()
...
async def generate_logo(zuli, message):
    ...
    r = requests.post("https://api.deepai.org/api/anime-world-generator", data=data, headers=headers)
    response = r.json()
